...
PROMPT_RESUMO = """Você é um analista de projetos de construção civil.
Com base nos dados extraídos abaixo de um projeto de alvará de construção da Prefeitura de Goiânia, gere um resumo objetivo e profissional em português, com no máximo 6 linhas.
    ...
    if dados_brutos:
        ...
        if TELEGRAM_TOKEN and TELEGRAM_CHAT_ID:
            ...
            if len(mensagens_tg) > 1:
                ...
                # Salva os IDs que foram enviados com sucesso
                ids_ja_enviados = carregar_ids_enviados()
                novos_ids = {
